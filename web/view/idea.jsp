...
<div class="imgList1">
    <div class="wrapper">
        <div class="box1"><a href="proDetail.html" class="banner"><img src="../photo/cc_img/idea1.jpg"/></a>
            <ul>
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea2.jpg"/></dt>
                ...
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea3.jpg"/></dt>
                ...
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea4.jpg"/></dt>
            ...
            <ul>
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea5.jpg"/></dt>
                ...
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea6.jpg"/></dt>
                ...
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea7.jpg"/></dt>
                        <dd>【最家】简约可爱创意玻璃水杯</dd>
                        <dd>¥22.00</dd>
                    </dl>
                </a></li>
            ...
            <ul>
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea8.jpg"/></dt>
                        <dd>【最家】简约可爱创意玻璃拼盘</dd>
                        <dd>¥33.00</dd>
                    </dl>
                </a></li>
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea9.jpg"/></dt>
                ...
                <li><a href="proDetail.html">
                    <dl>
                        <dt><img src="../photo/cc_img/idea10.jpg"/></dt>
                        <dd>【最家】创意多彩种子收纳摆件</dd>
                        <dd>¥49.00</dd>
                    </dl>
                </a></li>
