...
<%--                </ul>--%>
        ...
        <div class="you fl">
            <div class="tx clearfix">
                <div class="fl clearfix"><a href="#" class="fl"><img src="../${buyer.picUrl}"/></a>
                    <p class="fl"><span>${buyer.name}</span><a href="#">修改个人信息></a></p></div>
                <div class="fr">绑定邮箱：${buyer.email}</div>
            </div>
            <div class="bott">
                <div class="clearfix"><a href="#" class="fl"><img src="../photo/cc_img/gxin1.jpg"/></a>
                    <p class="fl"><span>待支付的订单：<strong>0</strong></span><a href="#">查看待支付订单></a></p></div>
                <div class="clearfix"><a href="#" class="fl"><img src="../photo/cc_img/gxin2.jpg"/></a>
                    <p class="fl"><span>待收货的订单：<strong>0</strong></span><a href="#">查看待收货订单></a></p></div>
                <div class="clearfix"><a href="#" class="fl"><img src="../photo/cc_img/gxin3.jpg"/></a>
                    <p class="fl"><span>待评价的订单：<strong>0</strong></span><a href="#">查看待评价订单></a></p></div>
                <div class="clearfix"><a href="#" class="fl"><img src="../photo/cc_img/gxin4.jpg"/></a>
