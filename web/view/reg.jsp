...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/cc_css/login.css"/>
    <script src="../js/cc_js/jquery-1.12.4.min.js"></script>
    <script src="../js/cc_js/calendar.js"></script>
    <script src="../js/cc_js/function.js"></script>
...
<body><!-------------------reg-------------------------->
<div class="reg">
    <form action="register" method="post" onsubmit="return checkForm(this)"><h1><a href="index.html"><img src="../photo/cc_img/temp/logo.png"></a></h1>
        ...
        <!--<a href="#" class="off"><img src="../photo/cc_img/temp/off.png"></a>--></form>
</div>
</body>
</html>