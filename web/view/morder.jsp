...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="../css/cc_css/mygxin.css"/>
</head>
<body><!----------------------------------------order------------------>
    ...
    <div class="orderCon wrapper clearfix">
        <div class="orderL fl"><!--------h3----------------><h3>收件信息<a href="#" class="fr">新增地址</a></h3>
            ...
            <div class="addres clearfix">
                <div class="addre fl on">
                    <div class="tit clearfix"><p class="fl">${buyer.name} <span class="default">[默认地址]</span></p>
                        <p class="fr"><a href="#">删除</a><span>|</span><a href="#" class="edit">编辑</a></p></div>
                    <div class="addCon"><p>${name.homeAddress }</p>
                        <p>15732570937</p></div>
                </div>
            </div>
            <h3>支付方式</h3><!--------way---------------->
            <div class="way clearfix"><img class="on" src="../photo/cc_img/temp/way01.jpg"><img src="../photo/cc_img/temp/way02.jpg"><img
                    src="../photo/cc_img/temp/way03.jpg"><img src="../photo/cc_img/temp/way04.jpg"></div>
            <h3>选择快递</h3><!--------dis---------------->
        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="showcart" class="fr">返回购物车</a></h3><!--------ul---------------->
                ...
                <ul class="clearfix">
                    <li class="fl"><img width="100" height="100" src="/${rs.goods[0].goodsPicUrl}"></li>
                    <li class="fl"><p>${rs.goods[0].goodsName}</p>
                        <p>颜色分类：烟灰色玻璃瓶</p>
                        <p>数量：1</p></li>
                    <li class="fr">￥${rs.order.totalPrice}</li>
                </ul>
                
                </c:forEach>
           
            </div><!--------tips---------------->
            <div class="tips"><p><span class="fl">商品金额：</span><span class="fr">￥${qOrders[0].order.totalPrice}</span></p>
